  ...
  return (
    <div className="min-h-screen">
      ...
      <div id="dashboard" className="bg-background py-12 px-4">
        ...
        >
          <h1 className="text-5xl font-bold mb-4 bg-gradient-to-r from-purple-600 to-pink-500 dark:from-purple-300 dark:to-orange-200 bg-clip-text text-transparent">
            Surgically AI
          </h1>
